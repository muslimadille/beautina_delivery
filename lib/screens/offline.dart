  ...
  buildBody(context){
    ...
    return Stack(children: [
      Align(
        ...
        child: Container(
          width: _screen_width,
          child:Image.asset("assets/splash_login_background_jpg",color: Color.fromRGBO(225,225,225, .1),),
        ),
          ...
          child: Column(
            children: [
              Padding(padding: const EdgeInsets.only(top: 40,),
                 child: Container(width:75,child: Image.asset("assets/delivery_app_logo.jpg")),
              ),
